...
const checkboxController = __importStar(require("../controllers/checkbox.controller"));
const router = express_1.default.Router();
router.get("/", checkboxController.getAllCheckboxes);
router.get("/:startRow/:endRow/:startCol/:endCol", checkboxController.getCheckboxesByRange);
